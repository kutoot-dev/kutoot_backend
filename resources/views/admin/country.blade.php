    ...
    <div class="main-content">
        <section class="section">
            ...
            <div class="section-body">
                <div class="row mb-3">
                    <div class="col-md-6">
                        <a href="{{ route('admin.country.create') }}" class="btn btn-primary"><i class="fas fa-plus"></i>
                            {{__('admin.Add New')}}</a>
                    </div>
                    <div class="col-md-6">
                        <form action="" method="GET" class="float-right">
                            <div class="input-group">
                                <input type="text" name="search" class="form-control"
                                    placeholder="{{__('admin.Search')}}..." value="{{ request('search') }}">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    @php
                                                        ...
                                                        $addressCount = \App\Models\Address::where('country_id', $country->id)->count();
                                                    @endphp

                                                    @if ($statesCount == 0 && $addressCount == 0)
                                                        <a href="javascript:;" data-toggle="modal" data-target="#deleteModal"
                                                            class="btn btn-danger btn-sm"
                                                            onclick="deleteData({{ $country->id }})"><i class="fa fa-trash"
                                                                aria-hidden="true"></i></a>
                                                    @else
                                                        <a href="javascript:;" data-toggle="modal" data-target="#canNotDeleteModal"
                                                            class="btn btn-danger btn-sm" disabled><i class="fa fa-trash"
                                                                aria-hidden="true"></i></a>
                                                    @endif
