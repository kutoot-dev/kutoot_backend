...
<div class="main-content">
    <section class="section">
        <div class="section-header">
            <h1>Edit Store Application deployment</h1>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="lat" id="lat" class="form-control" step="0.0000001" value="{{ old('lat', $application->lat) }}" placeholder="e.g., 12.9716">
                                        </div>

                                        <div class="form-group">
                                            <label>Longitude</label>
                                            <input type="number" name="lng" id="lng" class="form-control" step="0.0000001" value="{{ old('lng', $application->lng) }}" placeholder="e.g., 77.5946">
                                        </div>

                                        @if($application->lat && $application->lng)
                                        <a href="https://www.google.com/maps?q={{ $application->lat }},{{ $application->lng }}" id="googleMapsLink" target="_blank" class="btn btn-outline-primary btn-sm mb-2">
