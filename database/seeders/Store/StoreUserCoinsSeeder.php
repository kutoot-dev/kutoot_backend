...
class StoreUserCoinsSeeder extends Seeder
{
    /**
    ...
    public function run(): void
    {
        ...
        if ($purchasedCoins->isEmpty()) {
            $this->command->warn('No completed coin purchases found. Please run StorePurchasedCoinsSeeder first.');
            return;
        }
        ...
        $this->command->info('StoreUserCoinsSeeder completed.');
