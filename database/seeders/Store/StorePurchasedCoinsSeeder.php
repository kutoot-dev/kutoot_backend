...
class StorePurchasedCoinsSeeder extends Seeder
{
    /**
    ...
    public function run(): void
    {
        ...
        if ($campaigns->isEmpty()) {
            $this->command->warn('No campaigns found. Please run StoreCoinCampaignSeeder first.');
            return;
        }
        ...
        $this->command->info('StorePurchasedCoinsSeeder completed. ' . count($purchaseRecords) . ' purchases seeded.');
    }
}
